...
class IPhoneSubInfoUtil {

    static String getDeviceIdLevel0(Context context) {
    ...
    static String getDeviceIdLevel1(Context context) {
        try {
    ...
    static String getDeviceIdLevel2(Context context) {
        ...
        try {
            ...
            try {
                ...
                if (getDeviceId != null) {
                    deviceId =
                        binderGetHardwareInfo(context.getPackageName(), binder, getInterfaceDescriptor(binderProxy),
            ...
            Method getDeviceId = binderProxy.getClass().getDeclaredMethod("getDeviceId");
            if (getDeviceId != null) {
                deviceId = binderGetHardwareInfo("", binder, getInterfaceDescriptor(binderProxy),
                    getTransactionId(binderProxy, "TRANSACTION_getDeviceId"));
            }
        } catch (Exception e) {
            //();
    ...
    //    其实这里多一个参数并没有什么影响
    private static String binderGetHardwareInfo(String callingPackage, IBinder remote, String DESCRIPTOR, int tid)
    ...
    private static int getTransactionId(Object proxy, String name)
    ...
    //根据方法名，反射获得方法transactionId
    private static String getInterfaceDescriptor(Object proxy)
